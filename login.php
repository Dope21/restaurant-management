...
<body>
    <div class="login d-flex align-items-center justify-content-center">
        <form class=" d-flex flex-column align-items-center w-100" action="./login-check.php" method="POST">
            ...
            <div class="login__inputs d-flex flex-column align-items-center gap-3 gap-md-4">
                ...
                <a href="./register.php" class="text-decoration-none align-self-end mt-2">Create an Account</a>
            </div>
        </form>
    </div>
